...
export const get_albums_list = (ids, media) => ({
...
export const get_album_id_read = id => ({ type: types.GET_ALBUM_ID_READ, id })
export const get_album_id_readSucceeded = response => ({
  type: types.GET_ALBUM_ID_READ_SUCCEEDED,
  response
})
export const get_album_id_readFailed = error => ({
  type: types.GET_ALBUM_ID_READ_FAILED,
  error
})
